...
export namespace Images {
    ...
    export class ImagesChecked {
        ...
        static getPNG(): string { return require('assets/images/checked.png'); }
    }
    export class ImagesDown {
        static getName(): string { return 'down'; }

        static getPNG(): string { return require('assets/images/down.png'); }
    }
    export class ImagesInputArea {
        static getName(): string { return 'input_area'; }

        static getPNG(): string { return require('assets/images/input_area.png'); }
    }
    export class ImagesInputBorderColor {
        static getName(): string { return 'input_border_color'; }

        static getPNG(): string { return require('assets/images/input_border_color.png'); }
    }
    export class ImagesRadiobtnChecked {
        static getName(): string { return 'radiobtn_checked'; }

        static getPNG(): string { return require('assets/images/radiobtn_checked.png'); }
    }
    export class ImagesRadiobtnUnchecked {
        static getName(): string { return 'radiobtn_unchecked'; }
    ...
    export class ImagesUnchecked {
        ...
        static getPNG(): string { return require('assets/images/unchecked.png'); }
    }
    export class ImagesUp {
